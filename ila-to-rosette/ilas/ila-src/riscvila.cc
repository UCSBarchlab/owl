...
#include "../ila-include/helpers.h"
#include <iostream>

using namespace ilang;

#include "../ila-include/riscvila.h"
...
riscvILA_user::riscvILA_user(int pc_init_val)
        : model(InstrLvlAbs::New("riscv")), // define ila
          ...
          regfile(model.NewMemState("rf", REG_FILE_ADDR_LEN, REG_FILE_WORD)),
...
#define UPDATE_R(r, exp) instr.SetUpdate(regfile, StoreToMem(regfile, (r), (exp)))
...
void riscvILA_user::addInstructions() {
    ...
    // ------------------------------ //
    {
        auto rs1_val = Ite(rs1 == BvConst(0, 5), BvConst(0, XLEN), LoadFromMem(regfile, rs1));
        auto rs2_val = Ite(rs2 == BvConst(0, 5), BvConst(0, XLEN), LoadFromMem(regfile, rs2));
        ...
        // //
        {
            ...
            auto decode = (opcode == JAL) & (rd != BvConst(0, 5));
            instr.SetDecode(decode);
        ...
        // ------------------------------ //
        {
            ...
            auto decode = (opcode == JALR) & (rd != BvConst(0, 5));
            instr.SetDecode(decode);

            // instr.SetUpdate(pc, (rs1_val + immI) & bv(0xFFFFFFFE));
            instr.SetUpdate(pc, rs1_val + immI);
            UPDATE_R(rd, NC);
            RECORD_INST("JALR");
        }
    }
    ...
    // //
    {
        ...
        // //
        {
            ...
            auto decode = (opcode == LOAD) & (funct3 == WORD) & (rd != BvConst(0, 5));
            instr.SetDecode(decode);
        ...
        // //
        {
            ...
            auto decode = (opcode == LOAD) & (funct3 == HALF) & (rd != BvConst(0, 5));
            instr.SetDecode(decode);
        ...
        // //
        {
            ...
            auto decode = (opcode == LOAD) & (funct3 == BYTE) & (rd != BvConst(0, 5));
            instr.SetDecode(decode);
    ...
    // //
    {
        auto rs1_val = Ite(rs1 == BvConst(0, 5), BvConst(0, 32), LoadFromMem(regfile, rs1));
        auto rs2_val = Ite(rs2 == BvConst(0, 5), BvConst(0, 32), LoadFromMem(regfile, rs2));
        ...
        // //
        {
            ...
            auto decode = (opcode == OP) & (funct3 == ADD) & (funct7 == funct7_NM) & (rd != BvConst(0, 5));
            instr.SetDecode(decode);

            instr.SetUpdate(pc, nxt_pc);
            // instr.SetUpdate(regfile, StoreToMem(regfile, rd, rs1_val + rs2_val));
        ...
        // //
        {
            ...
            auto decode = (opcode == OP) & (funct3 == AND) & (funct7 == funct7_NM) & (rd != BvConst(0, 5));
            instr.SetDecode(decode);
...
//        // //
        {
            ...
            auto decode = (opcode == OP) & (funct3 == OR) & (funct7 == funct7_NM) & (rd != BvConst(0, 5));
            instr.SetDecode(decode);
...
//        // //
        {
            ...
            auto decode = (opcode == OP) & (funct3 == XOR) & (funct7 == funct7_NM) & (rd != BvConst(0, 5));
            instr.SetDecode(decode);
...
//        // //
        {
            ...
            auto decode = (opcode == OP) & (funct3 == SLL) & (funct7 == funct7_NM) & (rd != BvConst(0, 5));
            instr.SetDecode(decode);
...
//        // //
        {
            ...
            auto decode = (opcode == OP) & (funct3 == SRL) & (funct7 == funct7_NM) & (rd != BvConst(0, 5));
            instr.SetDecode(decode);
        ...
        // //
        {
            ...
            auto decode = (opcode == OP) & (funct3 == SUB) & (funct7 == funct7_PM) & (rd != BvConst(0, 5));
            instr.SetDecode(decode);
        ...
        // //
        {
            ...
            auto decode = (opcode == OP) & (funct3 == SRA) & (funct7 == funct7_PM) & (rd != BvConst(0, 5));
            instr.SetDecode(decode);
        ...
        // //
        {
            ...
            auto decode = (opcode == OP) & (funct3 == SLT) & (funct7 == funct7_NM) & (rd != BvConst(0, 5));
            instr.SetDecode(decode);
        ...
        // ------------------------------ //
        {
            ...
            auto decode = (opcode == OP) & (funct3 == SLTU) & (funct7 == funct7_NM) & (rd != BvConst(0, 5));
            instr.SetDecode(decode);
...
//    // ------------------------------ //
    {
        ...
        // ------------------------------ //
        {
            ...
            auto decode = (opcode == OPIMM) & (funct3 == ADDI) & (rd != BvConst(0, 5));
            instr.SetDecode(decode);
        ...
        // ------------------------------ //
        {
            ...
            auto decode = (opcode == OPIMM) & (funct3 == SLTI) & (rd != BvConst(0, 5));
            instr.SetDecode(decode);
...
//        // ------------------------------ //
        {
            ...
            auto decode = (opcode == OPIMM) & (funct3 == SLTIU) & (rd != BvConst(0, 5));
            instr.SetDecode(decode);
        ...
        // ------------------------------ //
        {
            ...
            auto decode = (opcode == OPIMM) & (funct3 == ANDI) & (rd != BvConst(0, 5));
            instr.SetDecode(decode);
        ...
        // //
        {
            ...
            auto decode = (opcode == OPIMM) & (funct3 == ORI) & (rd != BvConst(0, 5));
            instr.SetDecode(decode);
        ...
        // ------------------------------ //
        {
            ...
            auto decode = (opcode == OPIMM) & (funct3 == XORI) & (rd != BvConst(0, 5));
            instr.SetDecode(decode);
        ...
        // ------------------------------ //
        {
            ...
            auto decode =
                    (opcode == OPIMM) & (funct3 == SLLI) & (funct7 == SLLIfunct7) & (rd != BvConst(0, 5));
            instr.SetDecode(decode);
        ...
        // ------------------------------ //
        {
            ...
            auto decode =
                    (opcode == OPIMM) & (funct3 == SRLI) & (funct7 == SRLIfunct7) & (rd != BvConst(0, 5));
            instr.SetDecode(decode);
        ...
        // ------------------------------ //
        {
            ...
            auto decode =
                    (opcode == OPIMM) & (funct3 == SRAI) & (funct7 == SRAIfunct7) & (rd != BvConst(0, 5));
            instr.SetDecode(decode);
    ...
    // //
    {
        ...
        // //
        {
            ...
            auto decode = (opcode == LUI) & (rd != BvConst(0, 5));
            instr.SetDecode(decode);
        ...
        // ------------------------------ //
        {
            ...
            auto decode = (opcode == AUIPC) & (rd != BvConst(0, 5));
            instr.SetDecode(decode);
